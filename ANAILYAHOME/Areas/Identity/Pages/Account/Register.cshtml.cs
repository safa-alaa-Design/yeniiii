...
namespace ANAILYAHOME.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            //ulke ekle//
            [Required]
            [Display(Name = "Ülkenizi seçin")]
            public ulkeler ulkeler { get; set; }



            [Required]
            [StringLength(100, ErrorMessage = "Lütfen bir Adınız girin", MinimumLength = 3)]
            [Display(Name = "Adı")]
            public string Adi { get; set; }


            [Required]
            [StringLength(100, ErrorMessage = "Lütfen bir Soyadiniz girin.", MinimumLength = 3)]
            [Display(Name = "Soyadi")]
            ...
            if (ModelState.IsValid)
            {
                var user = new AplicationUser
                {
                    ...
                    Email = Input.Email,
                     Adi = Input.Adi,
                    Soyadi = Input.Soyadi,
                    //لضافته الى قاعدة البيانات
                    ulkeler=Input.ulkeler,
                ...
                if (result.Succeeded)
                {
                    ...
                    _logger.LogInformation("User created a new account with password.");
                     ...
                     await _userManager.AddToRoleAsync(user, clsRol.roleUser);
